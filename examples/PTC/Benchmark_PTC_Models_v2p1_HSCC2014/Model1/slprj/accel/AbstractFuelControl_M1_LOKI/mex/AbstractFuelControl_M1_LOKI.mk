...
MODEL                = AbstractFuelControl_M1_LOKI
MODULES              = AbstractFuelControl_M1_LOKI_acc.c AbstractFuelControl_M1_LOKI_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/AbstractFuelControl_M1_LOKI_acc.mexw64
MAKEFILE             = AbstractFuelControl_M1_LOKI.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = C:/Users/75780/Downloads/simulinkLoki/examples/PTC/Benchmark_PTC_Models_v2p1_HSCC2014/Model1
S_FUNCTIONS_LIB      = 
NUMST                = 4
NCSTATES             = 6
...
MODELLIB                  = AbstractFuelControl_M1_LOKI_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = AbstractFuelControl_M1_LOKI_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI \
...
AbstractFuelControl_M1_LOKI_acc.obj : $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/AbstractFuelControl_M1_LOKI_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/AbstractFuelControl_M1_LOKI_acc.c

AbstractFuelControl_M1_LOKI_acc_data.obj : $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/AbstractFuelControl_M1_LOKI_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/AbstractFuelControl_M1_LOKI_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AbstractFuelControl_M1_LOKI/rt_nonfinite.c
